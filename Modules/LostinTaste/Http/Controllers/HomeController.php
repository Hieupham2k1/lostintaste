...
namespace Modules\LostinTaste\Http\Controllers;
...
class HomeController extends Controller
{
    ...
    public function index(){
        ...
        return view('lostintaste::welcome', $var);
    }

    public function search(){
        return view('lostintaste::searcher');
    }
    ...
    public function selfInfo(){
        ...
        $var['user'] = auth()->user();
        return view('lostintaste::me', $var);
    }

    public function userProfile($id){
        $var['user'] = $this->queryService->findUser($id);
        $var['post'] = $var['user']->post()->with('user', 'user.info')->paginate(4);
        return view('lostintaste::personal.profile', $var);
    }

    public function updateUser($id){
        $var['user'] = $this->queryService->findUser($id);
        return view('lostintaste::personal.update-user', $var);
    }
    ...
    public function insertUser(Request $request){
        ...
        return redirect()->route('lostintaste.self_info');
    }

    // Post Controller
    public function post(){
        $var['post'] = $this->queryService->readPost();
        return view('lostintaste::personal.post', $var);
    }

    public function newPost(){
        return view('lostintaste::personal.new-post');
    }

    public function updatePost($id){
         $var['post'] = $this->queryService->findPost($id);
        return view('lostintaste::personal.new-post', $var);
    }
    ...
    public function savedpost()
    {
        ...
        return view('lostintaste::personal.savedpost', $var);
    }
    ...
    public function schedule()
    {
        ...
        return view('lostintaste::personal.schedule', $var);
    }
    
    public function newSchedule($id){
        $var['post'] = $this->queryService->findPost($id);
        return view('lostintaste::personal.new-schedule', $var);
    }
    ...
    public function insertSchedule(Request $request){
        ...
        return redirect()->route('lostintaste.schedule');
    }
    ...
    public function news(){
        ...
        return view('lostintaste::personal.news', $var);
    }
    ...
    public function friend()
    {
        ...
        return view('lostintaste::personal.friend', $var);
    }
    ...
    public function message(){
        ...
        return view('lostintaste::personal.message', $var);
    }
    ...
    public function inbox($id){
        ...
        return view('lostintaste::personal.inbox', $var);
    }
