                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="dropdown">
                        ...
                        @guest
                                ...
                                <a class="dropdown-item" href="{{ route('lostintaste.login') }}">{{ __('Login') }}</a>
                            
                            @if (Route::has('lostintaste.register'))
                                
                                    <a class="dropdown-item" href="{{ route('lostintaste.register') }}">{{ __('Register') }}</a>
                        ...
                        @else
                            <div class="navbar-item dropdown">
                                ...
                                <div class="" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('lostintaste.logout') }}"
                                    onclick="event.preventDefault();
                                    document.getElementById('logout-form').submit();">
                                        Logout
                                    </a>
                                    <form id="logout-form" action="{{ route('lostintaste.logout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
                                </div>
                            </div>
